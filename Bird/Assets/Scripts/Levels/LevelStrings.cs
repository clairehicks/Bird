...
public static class LevelStrings
{
    public static class LevelOne
    {
        ...
        public const string Flap = "Tap \"W\" to flap harder.";
        public const string FlapLess = "Excellent, now tap \"S\" to flap less.";
    ...
    public static class LevelThree
    {
        ...
        public const string Again = "You're still hungry. Use your claws again to open the next drawer and find another box.";
