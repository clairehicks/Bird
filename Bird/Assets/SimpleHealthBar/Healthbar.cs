...
public class Healthbar : MonoBehaviour {
    ...
    [Header("Draining:")]    
    // If 'drainHealth' is checked, character will drain health/sec at the rate of 'healthPerSecond':
    ...
    private void Update()
    {
        ...
        // If the character's health is not full and the health drain button is ticked, drain health/sec at the rate of 'healthPerSecond':
        if (health > minimumHealth && drainHealth)
        {
